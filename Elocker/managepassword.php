...
<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
    <input class="form-control mb-4 mt-4 w-50 border-top" name="search" list="datalistOptions" id="exampleDataList"
       ...
       echo '<td>'.$row['note'].'</td>';
       echo '<td><a href="updatedata.php?email=' .$row['email'] . '&links=' .$row['links'] . '&password=' .$row['password'] . '&note=' .$row['note'] . '" style="text-decoration:none; background-color:green; color:white; padding:5px; padding-right:10px; padding-left:10px; border-radius:4px;">Edit</a></td>';
