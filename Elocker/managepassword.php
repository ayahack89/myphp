              ...
              ';
                    if (mysqli_num_rows($run_sql) > 0) {
                        while ($row = mysqli_fetch_assoc($run_sql)) {
                            ...
                            echo '<td>' . $row['note'] . '</td>';
                            echo '<td><a href="updatedata.php?update=' . $row['id'] . '&email=' . $row['email'] . '&links=' . $row['links'] . '&password=' . $row['password'] . '&note=' . $row['note'] . '" style="text-decoration:none; background-color:green; color:white; padding:5px; padding-right:10px; padding-left:10px; border-radius:4px;">Edit</a></td>';
