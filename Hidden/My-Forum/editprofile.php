...
<body>
     ...
     if (isset($_POST['submit'])) {
          ...
          if (!empty($username) && !empty($about) && !empty($gender) && !empty($country) && !empty($pContact)) {
               $sql = "UPDATE `user` SET 
                    `username` = '$username',
                    `about` = '$about',
                    `gender` = '$gender',
          ...
          if (mysqli_num_rows($result) > 0) {
               while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <form action="" method="post">
                         ...
                         <textarea name="about" cols="70" rows="5" placeholder="About yourself... (Optional)"
                              style="font-family:sans-serif; margin-left:8px;"><?php echo $row['about']; ?></textarea>
                         <label for="pcontact">
                              <input type="text" name="pcontact" placeholder="Personal Contact (Optional)"
                                   value="<?php echo $row['personalcontact']; ?>"
