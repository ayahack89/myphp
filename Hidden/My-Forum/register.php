...
<body>
  ...
  <form action="register.php" method="post" enctype="multipart/form-data">
    ...
    <label for="retypepassword">
      <input type="password" name="repassword" placeholder="#retypepassword (required)" style="width:94%;" required />
    </label><br />
    <br />
    <hr>
    <label for="gender">
    ...
    <label for="proPic">
      <input type="file" name="profile_pic" style="border:2px solid gainsboro; padding:8px; margin:5px; width:50%;">
    </label><br><br>
