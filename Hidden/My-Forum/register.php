  ...
  <div class="container py-3 px-3">
    <form action="register.php" method="post" enctype="multipart/form-data">
      ...
      <label for="retypepassword">Retype Password
        <input type="password" name="repassword" placeholder="#retypepassword (required)" class="form-control"
          required />
      </label><br />
      <br />
      <label for="gender">Gender
        <select name="gender" class="form-select bg-light w-100" aria-label="Default select example">
          <option selected>Please select one(Oprional)</option>
      ...
      <label for=" country">Country
        <select name="country" class="form-select bg-light w-75" aria-label="Default select example">
      ...
      <label for="about">About
        <textarea name="about" cols="50" rows="2" placeholder="About your self... (Optional)"
          class="form-control"></textarea>
      </label><br>


      <label for="pContact">Personal Contact
        <input type="text" name="pcontact" class="form-control w-100" placeholder="Personal Contact (Optional)"
          style="border:2px solid gainsboro; padding:8px; margin:5px; width:94%;">
      </label><br>
      <label for="proPic">Choose a profile pic
