               ...
               if (isset($_SERVER["REQUEST_METHOD"]) == "POST") {
                    ...
                    if (!empty($_POST["name"]) && !empty($_POST["password"])) {
                         ...
                         if ($userAccount) {
                              ...
                              echo' <div class="alert alert-danger rounded-0" role="alert" style="font-size:15px;">Admin not found : (</div>';
                              

                         }
                    } else {
                        
                        echo' <div class="alert alert-danger rounded-0" role="alert" style="font-size:15px;">Please enter username and password very carefully</div>';
