                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    <a href="../main/thread.php?thread=<?php echo $row['thread_id']; ?>"
                        ...
                        <div class="ms-2 me-auto">
                            ...
                            <small class="text-muted">Comment by <strong
                                    class="text-danger"><?php echo htmlspecialchars($row['username']); ?></strong> on post
                                <strong><?php echo htmlspecialchars($row['thread_name']); ?></strong></small>
                        </div>
