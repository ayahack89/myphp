            ...
            <div class="mb-5 py-3">
                ...
                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post"
                    ...
                    <input class="form-control rounded-0" type="search"
                        placeholder="Search community by name, date, content.." name="search"
                ...
                <div class="container">
                    <p style="font-size:15px;">Please select a drive for your post. Create new drive? Click here &nbsp; <a
                            href="drives.php"><button class="btn btn-sm rounded-circle btn-dark"><i
                                    class="ri-arrow-right-double-fill"></i></button></a></p>
                    <?php
...
ORDER BY created DESC";
                    ...
                    if ($print) {
                        if (mysqli_num_rows($print) > 0) {
                            ...
                            echo ' <div class="alert alert-light rounded" role="alert" style="font-size:15px;">No disks found! Be the first person to create new disks.</div>';

                        }
                    } else {
                        echo ' <div class="alert alert-danger rounded" role="alert" style="font-size:15px;">Opps! Somthing went wrong : (</div>';
