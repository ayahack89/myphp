...
<body>
    ...
    <form action="resetpassword.php" class="container my-5" method="post">
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control rounded-0" placeholder="Please enter your valid email Id"
                name="user_email" aria-label="userEmail" aria-describedby="basic-addon1" required>
        </div>
