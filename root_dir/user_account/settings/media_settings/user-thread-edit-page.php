               ...
               if ($run && mysqli_num_rows($run) > 0) {
                    ...
                    if (isset($_POST['submit'])) {
                         ...
                         if (!empty($disk_name) || !empty($disk_desc)) {
                                        ...
                                        if ($image_size <= 999998) {
                                             ...
                                             if (move_uploaded_file($tmp_name, $image_path_destination . $image_new_name)) {
                                              ...
                                              WHERE `thread_id` = '{$edit_id}'";
                                                  ...
                                                  echo ' <div class="alert alert-danger rounded" role="alert" style="font-size:15px;">Opps! Error uploading image!</div>';
                                             }
                                        } else {
                                             echo ' <div class="alert alert-danger rounded" role="alert" style="font-size:15px;">Image size too large. Maximum size allowed is 1MB.</div>';
                                        }
                                   } else {
                                        echo ' <div class="alert alert-danger rounded" role="alert" style="font-size:15px;">Invalid file type. Only JPG, JPEG, PNG, and GIF files are allowed.</div>';
                                   }
                              } else {
                              ...
                              echo ' <div class="alert alert-danger rounded" role="alert" style="font-size:15px;">Please provide a thread name or thread content.</div>';
                         }
                    }
                    ?>
                    ...
                    <form class="container mt-5 bg-light py-5 px-5 border"
                         ...
                         <div class="mb-3">
                              <div class="input-group">
                                   ...
                                   <input type="text" class="form-control  rounded-0" id="basic-url"
                                        ...
                                        value="<?php echo $row['thread_name']; ?>">
                              </div>
                         </div>
                         <div class="input-group">
                         ...
                         <div class="mb-3">
                              <div class="input-group">
                                   ...
                                   <input type="text" class="form-control rounded-0" id="basic-url"
                                        aria-describedby="basic-addon3 basic-addon4" name="url" value="<?php echo $row['url']; ?>">
                              </div>
                         </div>
                         <br>
                         ...
                         <div class="input-group mb-3">
                              ...
                              <input type="file" class="form-control rounded" name="image" id="inputGroupFile01">
                         </div>


                         <button type="submit" class="btn btn-dark my-3 rounded" name="submit">Update thread</button>
                    </form>

                    <?php
               } else {
                    echo ' <div class="alert alert-warning rounded" role="alert" style="font-size:15px;">No thread found with this given ID!</div>';
               }
          } else {
