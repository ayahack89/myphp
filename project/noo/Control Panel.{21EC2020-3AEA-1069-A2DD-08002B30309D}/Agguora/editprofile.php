...
<body>
     ...
     <?php
     $update = isset($_GET['update']) ? mysqli_real_escape_string($conn, $_GET['update']) : null;
     if (!$update) {
          ...
          if (isset($_POST['submit'])) {
               ...
               if (!empty($username) && !empty($useremail)) {
                ...
                WHERE `id` = $update_id";
                    ...
                    if ($result) {
                         ?>
                         <script>window.location.href = "profile.php?update=<?php echo $update_id ?>"</script>
          ...
          if (mysqli_num_rows($result) > 0) {
               while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <form class="container py-3 px-4 bg-light border" action="" method="post">
                         ...
                         <div class="mb-3">
                              <label for="exampleFormControlInput1" class="form-label"><i class="ri-mail-fill"></i> Email
                                   address</label>
                         ...
                         <h4 style="text-align:center;" class="py-2">Optional edits</h4>
                         ...
                         <button type="submit" name="submit" class="btn btn-dark">Update profile details</button>
                    </form>
