...
<div class="container">
    <center>
        ...
        <form method="post">
            ...
            <input type="text" name="search" placeholder="Search.." style="padding:5px; width:50%; margin-bottom:10px; background-color:whitesmoke; border-radius:5px; border:1px inset gray;">
        ...
        if (isset($_POST["submit"])) {
            ...
            if (!empty($search)) {
                ...
                $sqlQuery = "SELECT * FROM `table` WHERE email LIKE '%$search%'";
