...
<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" class=" container d-flex my-3">
    ...
    <button type="submit" name="submit" class="btn btn-danger rounded-0"><i class="ri-search-line"></i></button>
</form>
...
<button class="btn btn-danger rounded"><a href="create-new-drive.php" class="text-light" style="text-decoration:none;">Create New Drive +</a></button>
</div>
<?php } ?>
