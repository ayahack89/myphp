                ...
                if ($result) {
                    if (mysqli_num_rows($result) > 0) {
                        while ($disk = mysqli_fetch_assoc($result)) {
                            ?>
                            <!-- Disk box -Start -->
<div class="card rounded-0 shadow-sm border-0 m-5">
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-start">
            <a href="user-disk-edit-page.php?edit=<?php echo $disk['catagory_id']; ?>" class="btn btn-outline-success btn-sm me-2"
               style="text-decoration:none;">
                <i class="ri-edit-box-line"></i> Edit
            </a>
            <a href="delete-your-disks.php?delete=<?php echo $disk['catagory_id']; ?>" class="btn btn-outline-danger btn-sm"
               style="text-decoration:none;">
