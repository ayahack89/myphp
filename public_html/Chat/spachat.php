...
define('DB_USERNAME',       'agguoras_alpha02');
define('DB_PASSWORD',       'agguora082004@alpha02');
define('DB_HOST',           'localhost');
define('DB_NAME',           'agguoras_agdatabase');
...
<body ng-controller="ChatAppCtrl">
    <div class="container">
        <div class="box box-warning direct-chat direct-chat-warning border">
            <div class="box-body">
            <div class="container bg-danger py-3 text-center text-light">
                Hey user, welcome to our live chat session, Let's share your thoughts and communicate with others.
            </div>
            <div class="alert alert-success" role="alert">
            Online users: {{ online.total || '1' }}
            </div>
                <div class="direct-chat-messages">
                    <div class="direct-chat-msg" ng-repeat="message in messages" ng-if="historyFromId < message.id" ng-class="{'right':!message.me}">
                        <div class="direct-chat-info clearfix" style="font-size:1rem;">
                            <span class="direct-chat-name"ng-class="{'pull-left':message.me, 'pull-right':!message.me}"><i class="ri-user-fill"></i> {{ message.username }}</span>
                            <span class="direct-chat-timestamp" style="font-size:12px;" ng-class="{'pull-left':!message.me, 'pull-right':message.me}">{{ message.date }}</span>
                        </div>
              
                        <div class="right bg-light text-dark py-3 px-3 border mt-1">
                ...
                <div class="box-footer">
                    <form ng-submit="saveMessage()">
                        <div class="input-group">
                            ...
                            <button type="submit" class="btn btn-danger btn-flat"><i class="ri-send-plane-fill"></i></button>
                            </span>
                        </div>
                    </form>
                    ...
                    <div class="clearfix">
                        ...
                        <button class="btn btn-xs btn-dark pull-right ml10 mx-2" type="button"><a  href="" data-toggle="modal" data-target="#choose-name" class="text-light" style="text-decoration:none; font-size:12px;">Choose username</a></button>
                        <button class="btn btn-xs btn-dark pull-right" type="button"><a  href="" data-toggle="modal" data-target="#clear-history"  class="text-light" style="text-decoration:none; font-size:12px;">Hide chat</a></button>
                        </div>
                        <!--
            ...
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-body">
                        <label class="radio">Choose a new name or enter your @username</label>
                        <input class="form-control" ng-model="me.username" autofocus="autofocus"
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal">ENTER <i class="ri-send-plane-line"></i></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-body">
                        <label class="radio">I want to hide my chat history.</label>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">No</button>
                        <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal" ng-click="clearHistory()">Yes</button>
                    </div>
                </form>
            </div>
        </div>
