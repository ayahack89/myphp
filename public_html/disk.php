                        ...
                        <div class="card-header">
                            <?php if (!empty($disk['created_by'])) { ?>
                                ...
                                if ($retrieve && mysqli_num_rows($retrieve) > 0) {
                                    ...
                                    ?>
                                    <b><a href="allprofile.php?user=<?php echo $row['id']; ?>" style="text-decoration:none;"
                                            class="text-dark"><?php echo $row['username']; ?></a></b>
                                    <?php
                                } else {
                    ...
                    <div class="card shadow-sm border-0 col-md-6 rounded" style="margin:auto;">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <a href="allprofile.php?user=<?php echo $thread['thread_user_id']; ?>"
                                        class="text-dark text-decoration-none fw-bold"><?php echo $thread['username']; ?></a>
                                    <p class="text-muted small mb-0">Posted at: <?php echo $thread['thread_time']; ?> &#8226; <i
                                            class="ri-earth-line" style="font-size:12px;"></i></p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-around mt-3">
                                ...
                                $comment_query = "SELECT COUNT(*) as total_comments FROM `comments` WHERE thread_id = '{$thread_id}'";
                                $comment_result = mysqli_query($conn, $comment_query);
                                $comments_count = $comment_result ? mysqli_fetch_assoc($comment_result)['total_comments'] : 0;
                                ?>
                                <a href="thread.php?thread=<?php echo $thread_id; ?>" class="btn btn-light btn-lg text-dark"><i
                                        class="ri-chat-3-line"></i> <?php echo $comments_count; ?></a>

                                <!-- Share Button -->
                                <a href="share.php?thread=<?php echo $thread_id; ?>" class="btn btn-light btn-lg text-dark"><i
