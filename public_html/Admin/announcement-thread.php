...
<head>
     ...
     <title>Announcement Thread | Admin Panel | Agguora</title>
</head>
    ...
    if ($method == 'POST') {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!empty($anno_topic) && !empty($anno_desc)) {
                ...
                echo' <div class="alert alert-danger rounded-0" role="alert" style="font-size:15px;">Please properly fill out the form!</div>';
