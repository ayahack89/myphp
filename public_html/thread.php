...
?>
    <meta name="description" content="<?php echo $th['thread_name']; ?>.. Discover a vibrant hub of discussion with our diverse range of threads! Stay informed with the latest updates, connect with fellow enthusiasts, and elevate your game to new heights...">
...
<body class="bg-light">
    ...
    if (!isset($thread['thread_user_id'])) {
        ...
        ?>
            <b><a href="allprofile.php?user=<?php echo htmlspecialchars($user['id']); ?>" style="text-decoration:none;" class="text-dark"><?php echo htmlspecialchars($user['username']); ?></a></b>
        <?php 
        } else {
            echo "Unknown user";
        }
    ...
    ?>
                                   ...
                                   <div class="card-body">
                                        ...
                                        <div class="container">
                                           <?php if(!empty($thread['url'])){ ?>
                                             <a href="<?php echo $thread['url']; ?>" target="_blank"  class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" ><i class="ri-external-link-fill"></i>https://ag-linked/redirect-url..</a>
                                             <?php }else{ ?>
                                             <?php } ?>
                                             <br><br>
                                             <?php
                                             if (empty($thread['uploaded_image'])) {
                                                  ...
                                                  <img src="img/upload/<?php echo $thread['uploaded_image']; ?>"
                                                       class="figure-img img-fluid rounded" alt="<?php echo $thread['thread_name']; ?>" width="1000px" height="1000px">
                                  ...
                                  Posted at: 
                                    ...
                                    echo $formattedTime;
                                    ?> &#183; <i class="ri-earth-line" style="font-size:12px; font-weight:light;"></i><br>
                                   <i class="ri-chat-3-line" style="font-size:12px; font-weight:light;"></i> <?php echo $row['total_rows']; ?> &#183; comments</b>
                                   <?php } ?>
                                        <!-- Voting System -Start  -->
                                        <div class="py-2"></div>
                                        <!-- Voting System -End  -->
...
<div class="container py-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="replyModalLabel">@<?php echo $_SESSION['username']; ?> <b style="font-size:12px">(you)</b></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF'] . '?thread=' . $thread_id); ?>" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a reply here" id="floatingTextarea" name="reply"></textarea>
    ...
    <?php } else { ?>
        ...
        <div class="alert alert-danger d-flex align-items-center" role="alert">
            ...
            <div>
                You are not logged in! Please <a href="login.php" class="alert-link">log in</a> to start the discussion.
            </div>
        </div>
                    ...
                    <div class="d-flex align-items-start bg-light py-1 px-3">
                        <div class="me-3">
                            <a href="allprofile.php?user=<?php echo $user['id']; ?>">
                                ...
                                <?php } else { ?>
                                    <img src="img/images/default.jpg" alt="Default profile" width="50px" height="50px" class="rounded-circle">
                                <?php } ?>
                            </a>
                        </div>
                        <div>
                            <h6 class="fw-bold mb-0">
                                <a href="allprofile.php?user=<?php echo $user['id']; ?>" class="text-dark text-decoration-none">
...
?>
    ...
    <a href="allprofile.php?user=<?php echo $tag_user['id']; ?>" class="text-dark text-decoration-none">
